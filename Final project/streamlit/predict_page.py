...
def load_model():
    with open(r'E:\traffic prediction project\final_model_1.pkl', 'rb') as f1:
        data1 = pickle.load(f1)
    with open(r'E:\traffic prediction project\final_model_2.pkl', 'rb') as f2:
        data2 = pickle.load(f2)
    with open(r'E:\traffic prediction project\final_model_3.pkl', 'rb') as f3:
        data3 = pickle.load(f3)
    with open(r'E:\traffic prediction project\final_model_4.pkl', 'rb') as f4:
